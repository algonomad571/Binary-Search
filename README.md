...
This folder contains the solutions to the following USACO problems:

| Question Name | Question Link | Solution File |
| :--- | :--- | :--- |
| Cow_libi | [Link](https://usaco.org/index.php?page=viewproblem2&cpid=1303) | [Cow_libi.cpp](./Cow_libi.cpp) |
